  ...
  return (
    <div className="max-w-full px-4 sm:px-6 lg:px-8 py-8" id="suggestions">
      <div className="mx-auto flex flex-col w-full lg:w-[1200px] items-center">
        {/* Title */}
        <h2 className="text-2xl sm:text-4xl mr-240 font-bold mb-8 text-center sm:text-left">
          Suggestions
        </h2>

        {/* card container */}
        <div className="flex flex-wrap gap-5 px-3 w-full lg:w-[1200px] justify-center lg:justify-around">
          {suggestions.map((item, index) => (
            <div key={index} className="w-full sm:w-[48%] lg:w-[370px]">
              <div className="bg-gray-100 h-[164px] px-3 mx-auto py-5 rounded-sm shadow flex justify-between">
                {/* Title + Description */}
