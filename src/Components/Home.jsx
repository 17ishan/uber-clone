...
import { getCurrentDate, getCurrentTime } from "../utils/getDatenTime";
        ...
        <div className="space-y-6  ">
          ...
          <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="relative">
                <div className="">
                  <svg
                    width="20"
                    height="10"
                    className="ml-1  absolute  pl-3 w-8 h-[48px]  rounded-l-md bg-gray-100"
                    viewBox="0 0 24 24"
                    fill="none"
                    data-baseweb="icon"
                  >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:space-x-4 space-y-3 sm:space-y-0">
              <button
                type="submit"
                className="bg-black text-white px-6 py-3 rounded-lg font-semibold w-full sm:w-auto hover:bg-gray-900"
              >
                Send mail
              </button>
              <a
